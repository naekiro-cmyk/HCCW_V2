...
const HERO_PHOTOS = [
window.__resources.heroPhoto1,
window.__resources.heroPhoto2,
window.__resources.heroPhoto3,
window.__resources.heroPhoto4,
window.__resources.heroPhoto5];
          ...
          <div className="hero__overlay" ref={titleRef}>
            <div className="hero__card">
              ...
              <p className="hero__sub">
                Bootcamps, team building et coaching collectif livrés à votre bureau. <strong>Une heure</strong> pour ressouder une équipe et recharger une semaine.
              </p>
