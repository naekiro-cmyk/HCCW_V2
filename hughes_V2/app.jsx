        ...
        <div className="manif__grid">
          <div className="manif__text">
            <h2 className="display-xl">
              On parle de <em>bien-être</em>.
              <br />
              <span className="display-xl__heavy">On ne bouge plus.</span>
            </h2>
            <p className="lede">
              Vos collaborateurs passent en moyenne <strong>7h41 assis</strong> par jour. Les
              webinaires sur la méditation ne changeront pas ça. Le sport collectif, si.
            </p>
          </div>
        ...
        <div className="coach__grid">
          <div className="coach__media-wrap">
            <div className="coach__media">
              <img src="assets/photo_08_coach.jpg" alt="Le coach HC" className="coach__img" />
            ...
            <div className="coach__ereps" title="Certifié EREPS EQF Level 4 — Personal Trainer">
              <img src="assets/ereps-eqf-level-4.webp" alt="EREPS EQF Level 4 — Personal Trainer" />
            </div>
          </div>
            ...
            <ul className="coach__creds">
              ...
              <li>
                ...
                <span>
                  ...
                  <span className="coach__creds-sub">
                    Désormais en entreprise — Bruxelles &amp; Wallonie
                  </span>
                </span>
              </li>
            </ul>
      ...
      <div className="wrap">
        ...
        <footer className="footer">
          <div className="footer__left">
            <img src="assets/hc-logo-white.png" alt="HC" className="footer__logo" />
            <div>
